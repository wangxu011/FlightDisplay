<template>
  <Layout_32>
    ...
    <div class="btn_wrap">
      ...
      <TrafficGuidance :layout="{marginTop: '2%', marginLeft: '2%'}"></TrafficGuidance>
    ...
    <div class="footer_wrap">
      <div class="left">
        ...
        <!-- <p class="line">
          <span class="privacy">{{$t('general.privacy')}}</span>
        </p> -->
      </div>
      <div class="right">
        <div class="code_wrap">
...
import ScanCard from '../../components/homeModule/32/ScanCard.vue'
